      ...
      <main className="under">
        <section className="contact-hd">
          <div className="tl-mds">
            ...
            <p>Cam kết bảo vệ quyền riêng tư &amp; dữ liệu khách hàng</p>
          </div>
        </section>

        <section className="contact-wrap">
          <div className="inner" style={{ maxWidth: '640px' }}>
            <h3 style={{ fontSize: '1.8rem', fontWeight: 500, color: '#555', marginBottom: '12px' }}>
            ...
            <h3 style={{ fontSize: '1.8rem', fontWeight: 500, color: '#555', marginBottom: '12px' }}>
              3. Bảo mật và quyền của người dùng
            </h3>
            <p style={{ marginBottom: '24px' }}>
