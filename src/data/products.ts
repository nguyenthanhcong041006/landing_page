...
export const products: Product[] = [
  {
    ...
    materials: '[Khung] Gỗ sồi tự nhiên, hợp kim nhôm, thép chịu lực\n[Chất liệu bọc] Da bò tự nhiên nguyên tấm cao cấp',
    ...
    description: 'foxx chair là dòng ghế thư giãn thực thụ có khả năng gập gọn tức thì. Cho dù đọc sách bên ô cửa sổ đón nắng sớm, hay thưởng thức những thước phim ấm cúng cùng gia đình tại phòng khách, bạn đều có thể tìm thấy phong cách thư thái mới mẻ và khác biệt.'
  },
  {
    id: 'lounge-table',
    name: 'Bàn Trà Xếp Gọn',
    subName: 'Bàn Trà Xếp Gọn',
    price: '66.000 ¥',
    priceNum: 66000,
    ...
    materials: '[Khung] Gỗ sồi đỏ tự nhiên, hợp kim nhôm cao cấp',
    colors: 'Màu gỗ tự nhiên / Màu đen tuyền',
    origin: 'Tiêu chuẩn chất lượng Nhật Bản',
  ...
  },
  {
    ...
    subName: 'Bàn Trà Phụ Cạnh Ghế',
    price: '55.000 ¥',
    priceNum: 55000,
    dimensions: 'Rộng khoảng 486 × Sâu khoảng 486 × Cao khoảng 560 mm',
    foldedDimensions: 'Rộng khoảng 120 × Sâu khoảng 650 × Cao khoảng 400 mm',
    weight: 'Khoảng 7.5 kg',
    materials: '[Khung] Gỗ sồi tự nhiên, hợp kim nhôm',
    colors: 'Màu gỗ tự nhiên / Màu đen tuyền',
    origin: 'Tiêu chuẩn chất lượng Nhật Bản',
